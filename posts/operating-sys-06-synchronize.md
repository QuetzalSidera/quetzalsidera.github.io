...
const singleInstanceDeadlockImage = {
  src: miscellaneousImagePath['单一实例死锁'],
  alt: '单一实例死锁',
  align: 'right',
  wrap: true,
  maxHeight: '16rem',
...
const multiInstanceDeadlockImage = {
  src: miscellaneousImagePath['多实例死锁'],
  alt: '多实例死锁',
  align: 'right',
  wrap: true,
  maxHeight: '16rem',
...
const multiInstanceNoDeadlockImage = {
  src: miscellaneousImagePath['多实例未死锁'],
  alt: '多实例未死锁',
  align: 'right',
  wrap: true,
  maxHeight: '16rem',
...
在 [进程（线程）调度](./operating-sys-05-scheduling.md) 中已讨论多执行实体如何共享
CPU。本篇聚焦多执行实体共享数据与资源时的执行次序约束。实践部分位于 [POSIX同步 API](./operating-sys-07-synchronize-posix.md)。
...
<Image v-bind="singleInstanceDeadlockImage" />
<Image v-bind="multiInstanceDeadlockImage" />
<Image v-bind="multiInstanceNoDeadlockImage" />
